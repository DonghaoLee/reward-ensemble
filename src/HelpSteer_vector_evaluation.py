...
from utils import evaluate_HelpSteer_vector
...
vectors = evaluate_HelpSteer_vector(reward_model, tokenizer, HelpSteer_dataset['validation'], device)
torch.save(vectors, "./ckpt/HelpSteertest_result_verbosity_epoch_3_vector.out")
